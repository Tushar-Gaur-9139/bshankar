...
<head>
    ...
    <!-- ========== Start Stylesheet ========== -->
     <link rel="stylesheet" href="Newsblog.css">
...
<body>
    ...
    <header id="home">
        ...
        <!-- Start Navigation -->
        <nav class="navbar navbar-default active-border navbar-sticky bootsnav" style="height: 80px;">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav navbar-center" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li>
                            ...
                            <!-- <ul class="dropdown-menu">
                                <li><a href="contact.php">Contact Form
                                    </a></li>
                                <li><a href="contact.php">Email Address</a></li>
                                <li><a href="contact.php">Social Media Links
                                    </a></li>
                            </ul> -->
                        </li>
